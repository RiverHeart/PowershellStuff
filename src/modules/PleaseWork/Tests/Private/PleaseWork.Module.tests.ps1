...
Describe 'PleaseWork module exports' {
    It 'exports the runner and its aliases from the module' {
        $Commands = Get-Command Complete-PleaseWorkTask, Invoke-PleaseWork, pw, please

        $Commands.Name | Should -Be @('Complete-PleaseWorkTask', 'Invoke-PleaseWork', 'pw', 'please')
        $Commands.ModuleName | Should -Be @('PleaseWork', 'PleaseWork', 'PleaseWork', 'PleaseWork')
    }
