...
App 'Window' {
    ...
    Content {
        DockPanel 'MainPanel' {
            ...
            Border 'FigureDrawingSidebar' {
                ...
                Dock Right
                Link Visibility -FromState IsFigureDrawingMode -Map @{
                    $true  = 'Visible'
                    $false = 'Collapsed'
                }
                ...
                StackPanel 'FigureDrawingSidebarStack' {
                    ...
                    Label 'FigureDrawingCountdownLabel' {
                        ...
                        Link Content -FromState FigureDrawingCountdownText
                    }

                    Label 'FigureDrawingMetaLabel' {
                        $this.HorizontalAlignment = [HorizontalAlignment]::Center
                        $this.Foreground = '#FFD3D3D3'
                        Link Content -FromState IsFigureDrawingPaused -Map @{
                            $true  = 'Paused'
                            $false = 'Running'
                        }
                    }
                    ...
                    Button 'FigureDrawingPauseButton' {
                        ...
                        Link ToolTip -FromState IsFigureDrawingPaused -Map @{
    ...
    Footer {
        ...
        StackPanel 'ButtonPanel' {
            ...
            Button 'CopyButton' {
                UseStyle 'ImageViewer.IconButton'
                Link IsEnabled -FromState IsFileLoaded
            ...
            Button 'ZoomModeButton' {
                UseStyle 'ImageViewer.IconButton'
                Link IsEnabled -FromState IsFileLoaded
                Link ToolTip -FromState IsFitMode -Map @{
                    $true  = 'Actual size (100%)'
                    $false = 'Fit image to window'
                }
                Link Content -FromState IsFitMode -Map @{
                    $true = (
