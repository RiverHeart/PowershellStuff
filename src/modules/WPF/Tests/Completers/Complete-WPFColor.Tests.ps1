Describe 'Complete-WPFColor' -Tag 'Complete-WPFColor' {
    ...
    It 'returns a hash-prefixed completion for six-digit hex input without a hash' {
    ...
    It 'returns a hash-prefixed completion for partial hex input that already starts with a hash' {
    ...
    It 'returns a hash-prefixed completion first for unprefixed partial hex input' {
        $result = @(Complete-WPFColor -WordToComplete 'ff')
