@{
    Document = @(
        ...
        @{ Name = 'RichText'; Extensions = 'rtf'; Filter = '(*.rtf)|*.rtf'; Description = 'Rich Text Format' }
        ...
        @{ Name = 'EPub'; Extensions = 'epub'; Filter = '(*.epub)|*.epub'; Description = 'E-book format' }
        ...
        @{ Name = 'Word'; Extensions = @('doc', 'docx', 'docm'); Filter = '(*.doc;*.docx;*.docm)|*.doc;*.docx;*.docm'; Description =  'Microsoft Word document' }

        # Open Document
        @{ Name = 'OpenText'; Extensions = @('odt', 'ott'); Filter = '(*.odt;*.ott)|*.odt;*.ott'; Description = 'Open Document Text' }
        @{ Name = 'OpenSpreadsheet'; Extensions = @('ods', 'ots'); Filter = '(*.ods;*.ots)|*.ods;*.ots'; Description = 'Open Document Spreadsheet' }
        @{ Name = 'OpenPresentation'; Extensions = @('odp', 'otp'); Filter = '(*.odp;*.otp)|*.odp;*.otp'; Description = 'Open Document Presentation' }
        @{ Name = 'OpenGraphic'; Extensions = @('odg', 'otg'); Filter = '(*.odg;*.otg)|*.odg;*.otg'; Description = 'Open Document Graphic' }
    )

    Images = @(
        @{ Name = 'JPEG'; Extensions = @('jpeg', 'jpg'); Filter = '(*.jpeg;*.jpg)|*.jpeg;*.jpg'; Description = 'JPEG Image' }
        ...
        @{ Name = 'WebP'; Extensions = 'webp'; Filter = '(*.webp)|*.webp'; Description = 'Google Image Format' }
    )
    ...
    Programming = @(
        ...
        @{ Name = 'PowershellData'; Extensions = 'psd1'; Filter = '(*.psd1)|*.psd1'; Description = 'Powershell Data File' }
        @{ Name = 'PowershellModule'; Extensions = 'psm1'; Filter = '(*.psdm1)|*.psm1'; Description = 'Powershell Module File' }
    )
