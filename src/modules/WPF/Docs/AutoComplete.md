...
Tab completion is provided through the [TabCentral](../../TabCentral/) module which you would have to install so you can run `notepad $PROFILE` and add the following, substituting the PSModulePath as necessary.
