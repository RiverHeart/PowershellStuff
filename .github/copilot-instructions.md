...
- `.github/skills/pwsh-test-runner`: A skill for discovering, listing, and running tests across the repository, including Pester suite discovery, tag discovery, and execution. Before any test execution, load this skill and follow its workflow, using `./tools/Invoke-Test.ps1` as the default test entrypoint.
