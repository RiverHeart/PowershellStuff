...
3. Use `./tools/Invoke-Test.ps1 -TestSuite WPF` as the default test invocation path.
...
```powershell
./tools/Invoke-Test.ps1 -TestSuite WPF
```
...
```powershell
# Primary gate
powershell.exe -NoProfile -File "tools/Invoke-Test.ps1" -TestSuite WPF

# Secondary gate
pwsh.exe -NoProfile -File "tools/Invoke-Test.ps1" -TestSuite WPF
```
